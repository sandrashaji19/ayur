...
app.post('/signup', pdfupload, (req, res) => {
  ...
  if (error) {
              ...
              if (results.length > 0) {
                connection.query(
                    ...
                    [username, password], function(error, results, fields) {
                      ...
                      if (results.length > 0) {
                        response.cookie('user', encrypt(username, key), {
                          maxAge: 604800000,
                          httpOnly: true,
                          sameSite: 'strict'
                        })
      ...
      connection.query(
          'SELECT * FROM doctors', function(error, results, fields) {
            ...
            if (results.length > 0) {
              ...
              res.render(
                  __dirname + '/doctors',
                  {data: results, user: decrypt(req.cookies.user, key)});
            } else {
              ...
              if (error) {
                ...
                if (results.length > 0) {
                  ...
                  res.render(__dirname + '/treatment', {
                    ...
                    user: decrypt(req.cookies.user, key)
                  })
                }
              }
            })
              ...
              if (error) {
                ...
                if (results.length > 0) {
                  ...
                  connection.query(
                      ...
                      [
                        parseInt(decrypt(req.cookies.uid, key)), req.body.date,
    ...
    app.post('/doctorsappo', pdfupload, (req, res) => {
      ...
      var uid = parseInt(decrypt(req.cookies.uid, key));
      connection.query(
